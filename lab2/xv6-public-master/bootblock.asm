...
outb(ushort port, uchar data)
{
  ...
  outb(0x1F6, (offset >> 24) | 0xE0);
    ...
    7cd6:	ee                   	out    %al,(%dx)
    7cd7:	b8 20 00 00 00       	mov    $0x20,%eax
...
00007d3a <bootmain>:
{
  ...
  if(elf->magic != ELF_MAGIC)
    ...
    7d5c:	45 4c 46 
    7d5f:	74 08                	je     7d69 <bootmain+0x2f>
}
    7d61:	83 c4 0c             	add    $0xc,%esp
    7d64:	5b                   	pop    %ebx
    7d65:	5e                   	pop    %esi
    7d66:	5f                   	pop    %edi
    7d67:	5d                   	pop    %ebp
  ...
  ph = (struct proghdr*)((uchar*)elf + elf->phoff);
    ...
    7d6e:	8d 98 00 00 01 00    	lea    0x10000(%eax),%ebx
  eph = ph + elf->phnum;
  ...
  for(; ph < eph; ph++) {
    ...
    7d82:	73 3b                	jae    7dbf <bootmain+0x85>
}
...
stosb(void *addr, int data, int cnt)
{
  asm volatile("cld; rep stosb" :
    7d84:	bd 00 00 00 00       	mov    $0x0,%ebp
    7d89:	eb 07                	jmp    7d92 <bootmain+0x58>
    7d8b:	83 c3 20             	add    $0x20,%ebx
    7d8e:	39 de                	cmp    %ebx,%esi
    7d90:	76 2d                	jbe    7dbf <bootmain+0x85>
    va = (uchar*)(ph->va & 0xFFFFFF);
    7d92:	8b 7b 08             	mov    0x8(%ebx),%edi
    7d95:	81 e7 ff ff ff 00    	and    $0xffffff,%edi
    readseg(va, ph->filesz, ph->offset);
    7d9b:	ff 73 04             	pushl  0x4(%ebx)
    7d9e:	ff 73 10             	pushl  0x10(%ebx)
    7da1:	57                   	push   %edi
    7da2:	e8 54 ff ff ff       	call   7cfb <readseg>
    if(ph->memsz > ph->filesz)
    7da7:	8b 4b 14             	mov    0x14(%ebx),%ecx
    7daa:	8b 43 10             	mov    0x10(%ebx),%eax
    7dad:	83 c4 0c             	add    $0xc,%esp
    7db0:	39 c1                	cmp    %eax,%ecx
    7db2:	76 d7                	jbe    7d8b <bootmain+0x51>
      stosb(va + ph->filesz, 0, ph->memsz - ph->filesz);
    7db4:	01 c7                	add    %eax,%edi
    7db6:	29 c1                	sub    %eax,%ecx
    7db8:	89 e8                	mov    %ebp,%eax
    7dba:	fc                   	cld    
    7dbb:	f3 aa                	rep stos %al,%es:(%edi)
    7dbd:	eb cc                	jmp    7d8b <bootmain+0x51>
  entry = (void(*)(void))(elf->entry & 0xFFFFFF);
    7dbf:	a1 18 00 01 00       	mov    0x10018,%eax
    7dc4:	25 ff ff ff 00       	and    $0xffffff,%eax
  entry();
    7dc9:	ff d0                	call   *%eax
    7dcb:	eb 94                	jmp    7d61 <bootmain+0x27>
